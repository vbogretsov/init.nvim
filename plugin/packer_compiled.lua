...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'bufdelete.nvim', 'lualine.nvim', 'bufferline.nvim', 'packer.nvim', 'easyclip.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'vim-surround', 'indent-blankline.nvim', 'nvim-treesitter', 'virt-column.nvim', 'nvim-cmp'}, { event = "BufRead *" }, _G.packer_plugins)]]
